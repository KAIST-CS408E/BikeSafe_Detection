...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bikeSessionButton = findViewById(R.id.button);
        bikeSessionButton.setOnClickListener(new View.OnClickListener() {
            @Override
